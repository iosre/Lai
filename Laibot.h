...
- (BOOL)deleteContact:(CContact *)arg1 listType:(NSUInteger)arg2 andScene:(NSUInteger)arg3 sync:(BOOL)arg4 local:(BOOL)arg5; // 2, 0, YES, NO; 1, 0, NO, YES
- (BOOL)isInContactList:(NSString *)userID;
- (NSArray *)getContactList:(NSUInteger)arg1 contactType:(NSUInteger)arg2; // 1, 0
@end
